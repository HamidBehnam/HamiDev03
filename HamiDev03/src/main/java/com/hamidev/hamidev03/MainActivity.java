...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new PlaceholderFragment(), "mainPlaceholderFragment")
                    .commit();
        }
    }
    ...
    public void showResultDialog(View view) {
        ...
        EditText editText = (EditText)getSupportFragmentManager().findFragmentByTag("mainPlaceholderFragment").getView().findViewById(R.id.editText);

        AlertFragment myAlert = new AlertFragment("Hamid Behnam", editText.getText().toString());
